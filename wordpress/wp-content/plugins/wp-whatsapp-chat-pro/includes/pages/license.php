  ...
  <table class="widefat striped">
    ...
    <tbody>
      <tr>
        ...
        <td>
          <select name="<?php echo esc_attr(QLWAPP_DOMAIN); ?>[license][market]" style="width:350px">
            <option <?php selected($qlwapp['license']['market'], ''); ?> value="">QuadLayers</option>
            <option <?php selected($qlwapp['license']['market'], 'envato'); ?> value="envato">Envato</option>
            <option <?php selected($qlwapp['license']['market'], 'emp'); ?> value="emp">Elegant Market Place</option>
          </select>
      ...
      <tr>
        ...
        <td>
          <input type="password" name="<?php echo esc_attr(QLWAPP_DOMAIN . '[license][key]'); ?>" placeholder="<?php esc_html_e('Enter your license key.', 'wp-whatsapp-chat-pro'); ?>" value="<?php echo esc_attr($qlwapp['license']['key']); ?>" class="qlwapp-input"/>
        </td>
      </tr>
      <tr>
        <th scope="row"><?php esc_html_e('Email', 'wp-whatsapp-chat-pro'); ?></th>
        <td>
          <input type="password" name="<?php echo esc_attr(QLWAPP_DOMAIN . '[license][email]'); ?>" placeholder="<?php esc_html_e('Enter your order email.', 'wp-whatsapp-chat-pro'); ?>" value="<?php echo esc_attr($qlwapp['license']['email']); ?>" class="qlwapp-input"/>
        </td>
      </tr>
    </tbody>
  </table>
