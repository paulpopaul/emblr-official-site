...
<section id="noticias" class="noticias target-section section-page">
	<div class="slick-stories-container">
		<!-- prev, next arrows -->
		<span class="slick-stories-prev slick-stories-arrow"><i class="fa fa-arrow-left"></i></span>
		<span class="slick-stories-next slick-stories-arrow"><i class="fa fa-arrow-right"></i></span>
